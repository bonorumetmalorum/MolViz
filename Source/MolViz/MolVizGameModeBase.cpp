...
void AMolVizGameModeBase::BeginPlay()
{
	...
	Cast<AMousePlayerController>(UGameplayStatics::GetPlayerController(this, 0))->ProteinRep = ProteinRepresentation;
...
{
	RepresentationFactory->CreateNewCpkRep(Cast<AProteinRepresentation>(ProteinRepresentation), ProteinData, "CPK");
}
